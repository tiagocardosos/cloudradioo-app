...
exports.default = {
  vuex: {
    ...
    actions: {
      initCurrentTrack: _actions.initCurrentTrack
    }
  },
  ...
  ready: function ready() {
    ...
    setTimeout(function () {
      _this.showToolsOnStart = false;
    }, 2000);
  },

  methods: {
    enableShareTrack: function enableShareTrack() {
    ...
    disableShareTrack: function disableShareTrack() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-31671d8e", module.exports)
  } else {
...
exports.default = {
  vuex: {
    getters: {
      audio: function audio(_ref) {
        var player = _ref.player;
        return player.audio;
      },
      playing: function playing(_ref2) {
      ...
      repeat: function repeat(_ref4) {
        var options = _ref4.options;
        return options.repeat;
      },
      currentTrack: function currentTrack(_ref5) {
    ...
    actions: {
      initCurrentTrack: _actions.initCurrentTrack,
      playPause: _actions.playPause,
      changeSubNav: _actions.changeSubNav,
      changeRepeat: _actions.changeRepeat,
      changeVolumeBy: _actions.changeVolumeBy,
      initPreviousTrack: _actions.initPreviousTrack
    }
  },

  components: {
    SubNavigation: _subnav2.default
  },

  ready: function ready() {
    var _this = this;

    var savedVolume = localStorage.getItem('user-volume');
    if (savedVolume == null) {
      savedVolume = .75;
    }
...
exports.default = {
  vuex: {
    getters: {
      progressBar: function progressBar(_ref) {
        var progress = _ref.progress;
        return progress.progressBar;
      },
      durationTime: function durationTime(_ref2) {
        var progress = _ref2.progress;
        return progress.durationTime;
      },
      durationProgress: function durationProgress(_ref3) {
        var progress = _ref3.progress;
        return progress.durationProgress;
      }
    },
    actions: {
      seekTrack: _actions.seekTrack
    }
  },
  ...
  methods: {
    click: function click(event) {
      ...
      var clickedWidthPercent = 100 * clientX / progressWidth;
      var durationTimeSeconds = this.durationTime / 1000;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-664416ee", module.exports)
  } else {
...
var _keyevents = require('./keyevents');
...
_vue2.default.filter('convertDuration', _filters.convertDuration);
_vue2.default.filter('reverse', _filters.reverse);
...
new _vue2.default({
  ...
  components: {
    ...
    cloudradiooHeader: _header2.default,
  ...
  ready: function ready() {
    ...
    this.$http.get('http://localhost:8000/api/api-key').then(function (value) {
      ...
      _keyevents2.default.registerKeyEvents();
    });
  }
});
...
var PLAY_PAUSE = 32;
var CLOSE_SUB_NAV = 27;

var NEXT_TRACK = 39;
var NEXT_TRACK_SECOND = 68;
var PREV_TRACK = 37;
var PREV_TRACK_SECOND = 65;

var VOLUME_HIGHER = 38;
var VOLUME_HIGHER_SECOND = 87;
var VOLUME_LOWER = 40;
var VOLUME_LOWER_SECOND = 83;

var keyEvents = new _vue2.default({
  store: _store2.default,
  ...
  methods: {
    registerKeyEvents: function registerKeyEvents() {
      var _this = this;
      ...
      window.onkeyup = function (event) {
        ...
        switch (key) {
          case PLAY_PAUSE:
            _store2.default.dispatch('PLAY_PAUSE');
            break;

          case NEXT_TRACK:
          case NEXT_TRACK_SECOND:
            _this.initCurrentTrack();
            break;

          case PREV_TRACK:
          case PREV_TRACK_SECOND:
            _this.initPreviousTrack();
            break;

          case VOLUME_HIGHER:
          case VOLUME_HIGHER_SECOND:
            _store2.default.dispatch('CHANGE_VOLUME', 'increase');
            break;

          case VOLUME_LOWER:
          case VOLUME_LOWER_SECOND:
            _store2.default.dispatch('CHANGE_VOLUME', 'decrease');
            break;

          case CLOSE_SUB_NAV:
            _store2.default.dispatch('CHANGE_SUB_NAV', null);
            break;
        }
      };
    }
...
var player = new _vue2.default({
  ...
  vuex: {
    getters: {
      ...
      currentPlayingIndex: function currentPlayingIndex(_ref2) {
        var player = _ref2.player;
        return player.currentPlayingIndex;
      },
      audio: function audio(_ref3) {
        var player = _ref3.player;
        return player.audio;
      },
      apiKey: function apiKey(_ref4) {
    ...
    actions: {
      initCurrentTrack: _actions.initCurrentTrack,
      initUserFilters: _actions.initUserFilters,
      initUserHistory: _actions.initUserHistory,
      initVolume: _actions.initVolume
    }
  },
  ...
  methods: {
    start: function start() {
      ...
      this.$http.get('http://localhost:8000/api/all-genres').then(function (value) {
        ...
        _this.initVolume();
        _this.initUserFilters();
        _this.initUserHistory();
        _this.initAllTracks();
      });
    },
    ...
    initAllTracks: function initAllTracks() {
      ...
      this.$http.get('http://localhost:8000/api/songs', { filters: this.userFilters }).then(function (value) {
        ...
        if (_this2.sharedTrack) {
          _this2.$http.get('http://api.soundcloud.com/tracks/' + _this2.sharedTrack + '?client_id=' + _this2.apiKey).then(function (value) {
            _store2.default.dispatch('INIT_SHARED_TRACK', value.data);
            _this2.initPlayer();
          }, function (error) {
            window.location.href = document.querySelector('.base-uri').content;
          });
        } else {
          _store2.default.dispatch('INIT_CURRENT_TRACK');
          _this2.initPlayer();
        }
      });
    },
    ...
    startPlaying: function startPlaying() {
      var title = this.currentTrack.title;
      var author = this.currentTrack.username;
      ...
      _store2.default.dispatch('SET_DURATION', this.duration);
      _store2.default.dispatch('CHANGE_TITLE', title + ' - ' + author);
    ...
    initAudioContext: function initAudioContext() {
      ...
      _d2.default.selectAll('.svg-wrap svg').remove();
      var svg = _d2.default.select('.svg-wrap').append('svg');

      function renderSVG() {
        _store2.default.dispatch('UPDATE_PROGRESS_BAR', 100 * Math.ceil(self.audio.currentTime * 1000) / self.duration);
        _store2.default.dispatch('UPDATE_DURATION_PROGRESS', Math.ceil(self.audio.currentTime * 1000));
        ...
        var radiusScale = _d2.default.scale.linear().domain([0, _d2.default.max(frequencyData)]).range([0, 1200 / 2]);
    ...
    audioError: function audioError() {
    ...
    audioCanPlay: function audioCanPlay() {
      this.startPlaying();
    }
  }
});
...
exports.initUserFilters = initUserFilters;
exports.changeFilter = changeFilter;
exports.toggleAllFilters = toggleAllFilters;
exports.initUserHistory = initUserHistory;
exports.clearHistory = clearHistory;
exports.initTrackFromHistory = initTrackFromHistory;
exports.playPause = playPause;
exports.seekTrack = seekTrack;
exports.initCurrentTrack = initCurrentTrack;
exports.initPreviousTrack = initPreviousTrack;
exports.initVolume = initVolume;
exports.changeVolumeBy = changeVolumeBy;
...
// Filter stuff.
function initUserFilters(_ref) {
  var dispatch = _ref.dispatch;

  dispatch('INIT_FILTERS');
}

function changeFilter(store, key, value) {
  store.dispatch('CHANGE_FILTER', key, value);

  callChangeFilter(store, this);
}

function toggleAllFilters(store) {
...
// History stuff.
function initUserHistory(_ref2) {
  var dispatch = _ref2.dispatch;

  dispatch('INIT_HISTORY');
}

function clearHistory(_ref3) {
  var dispatch = _ref3.dispatch;

  dispatch('CLEAR_HISTORY');
}

function initTrackFromHistory(_ref4, item) {
  var dispatch = _ref4.dispatch;

  dispatch('INIT_TRACK_FROM_HISTORY', item);
  dispatch('ADD_ITEM_TO_HISTORY', item);

  _player2.default.initPlayer();
}

// Player stuff.
function playPause(_ref5) {
  var dispatch = _ref5.dispatch;

  dispatch('PLAY_PAUSE');
}

function seekTrack(_ref6, duration) {
  var dispatch = _ref6.dispatch;

  dispatch('SEEK_TRACK', duration);
}

function initCurrentTrack(_ref7) {
...
function initPreviousTrack(_ref8) {
...
function initVolume(_ref9) {
  var dispatch = _ref9.dispatch;

  dispatch('INIT_VOLUME');
}

function changeVolumeBy(_ref10, value) {
...
// Other stuff.
function changeSubNav(_ref11, item) {
  var dispatch = _ref11.dispatch;

  dispatch('CHANGE_SUB_NAV', item);
}

function changeRepeat(_ref12) {
...
var mutations = {
  INIT_FILTERS: function INIT_FILTERS(state) {
    var savedFilters = localStorage.getItem('user-filters');
  ...
  INIT_ALL_GENRES: function INIT_ALL_GENRES(state, genres) {
    state.allGenres = genres;
  },
  SET_STORAGE: function SET_STORAGE(state) {
    setStorage(state.userFilters);
  },
  CHANGE_FILTER: function CHANGE_FILTER(state, key, value) {
...
var mutations = {
  CHANGE_REPEAT: function CHANGE_REPEAT(state) {

    // todo
    state.repeat = !state.repeat;
  },
  CHANGE_TITLE: function CHANGE_TITLE(state, title) {
    document.title = title;
  },
  CHANGE_SUB_NAV: function CHANGE_SUB_NAV(state, item) {
...
var mutations = {
  INIT_TRACK_FROM_HISTORY: function INIT_TRACK_FROM_HISTORY(state, item) {
    state.playing = true;
    state.currentTrack = item;
  },
  INIT_HISTORY: function INIT_HISTORY(state) {
    var savedHistory = localStorage.getItem('user-history');
  ...
  ADD_ITEM_TO_HISTORY: function ADD_ITEM_TO_HISTORY(state, item) {
  ...
  RESET_PLAYING_INDEX: function RESET_PLAYING_INDEX(state) {
    state.currentPlayingIndex = 0;
  },
  SEEK_TRACK: function SEEK_TRACK(state, duration) {
    state.playing = true;
  ...
  CREATE_AUDIO: function CREATE_AUDIO(state, id) {
    var src = 'http://api.soundcloud.com/tracks/' + id + '/stream?client_id=' + state.apiKey;
  ...
  INIT_VOLUME: function INIT_VOLUME(state) {
    var savedVolume = localStorage.getItem('user-volume');
  ...
  CHANGE_VOLUME: function CHANGE_VOLUME(state, type) {
    var volume = state.audio.volume;
    var slider = document.getElementById('volume');
  ...
  CHANGE_VOLUME_BY: function CHANGE_VOLUME_BY(state, value) {
    if (state.audio) {
  ...
  INIT_ALL_TRACKS: function INIT_ALL_TRACKS(state, tracks) {
    state.allTracks = tracks;
    state.lastTrackIndex = tracks.length - 1;
  },
  INIT_PREVIOUS_TRACK: function INIT_PREVIOUS_TRACK(state) {
    state.playing = true;
  ...
  INIT_SHARED_TRACK: function INIT_SHARED_TRACK(state, data) {
    state.currentTrack = {
  ...
  INIT_CURRENT_TRACK: function INIT_CURRENT_TRACK(state) {
    state.playing = true;
...
var mutations = {
  UPDATE_PROGRESS_BAR: function UPDATE_PROGRESS_BAR(state, width) {
    state.progressBar = width;
  },
  SET_DURATION: function SET_DURATION(state, duration) {
    state.durationTime = duration;
  },
  UPDATE_DURATION_PROGRESS: function UPDATE_DURATION_PROGRESS(state, duration) {
